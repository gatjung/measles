        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
            	...
            	<?php if(!empty($_GET['txt'])){?>
					<div class="alert alert-primary text-center" role="alert"><h2><i class="fa fa-check"></i> <?php echo $_GET['txt']?></h2></div>
				<?php }?>
                      ...
                      <div class="card-body card-block">
                          ...
                          <div class="row form-group">
                                <div class="col-md-6">
                                    ...
                                    <div class="col col-md-4 text-desktop-right"><label class=" form-control-label">รหัสผู้ป่วย:</label></div>
                                    <div class="col-12 col-md-8"><input type="text" name="" id="" class="form-control"  value="<?php echo $report->report_id?>" disabled></div>
                                    <?php }else{?>
                                    <div class="col col-md-4 text-desktop-right"><label class=" form-control-label">เลขประจำตัวประชาชน:</label></div>
                                    <div class="col-12 col-md-8"><input type="text" name="id_number" id="id_number" class="form-control" value="<?php echo $report->id_number?>" readonly placeholder=""></div>
                                    <?php }?>
                                </div><div class="col-md-6">
                                    <div class="col col-md-4 text-desktop-right"><label class=" form-control-label required">คำนำหน้านาม:</label></div>
                          ...
                          <div class="row form-group">
                                <div class="col-md-6">
                                    <div class="col col-md-4 text-desktop-right"><label class=" form-control-label required">ชื่อ:</label></div>
                                    <div class="col-12 col-md-8"><input type="text" name="first_name" class="form-control" required value="<?php echo $report->first_name?>"></div>
                                </div><div class="col-md-6">
                                    <div class="col col-md-4 text-desktop-right"><label class=" form-control-label required">นามสกุล:</label></div>
                                    <div class="col-12 col-md-8"><input type="text" name="last_name" class="form-control" required value="<?php echo $report->last_name?>"></div>
                                </div>
                          </div>

                          <div class="row form-group">
                                <div class="col-md-6">
                                    <div class="col col-md-4 text-desktop-right"><label class=" form-control-label required">อายุ:</label></div>
                                    <div class="col-12 col-md-8">
                                ...
                                <div class="col-md-6">
                                    <div class="col col-md-4 text-desktop-right"><label class=" form-control-label required">วัน/เดือน/ปีเกิด:</label></div>
                                    <div class="col-12 col-md-8"><input type="text" name="dob" class="form-control datepicker" required="" value="<?php echo $report->dob?>"></div>
                                </div>
                          </div>

                          <div class="row form-group">
                                <div class="col-md-6">
                                    <div class="col col-md-4 text-desktop-right"><label class=" form-control-label">เพศ:</label></div>
                                    <div class="col-12 col-md-8">
                          ...
                          <div class="row form-group">
                                <div class="col-md-6">
                                    <div class="col col-md-4 text-desktop-right"><label class=" form-control-label">เชื้อชาติ:</label></div>
                                    <div class="col-12 col-md-8">
                                    ...
                                    <div class="col-12 col-md-8">
										<select data-placeholder="" class="standardSelectCustom" required name="occupation" id="occupation">
                          ...
                          <div class="row form-group">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-12 col-md-8">
										<select data-placeholder="กรุณาเลือก...." class="standardSelect" required name="address_province" id="address_province">
                                    ...
                                    <div class="col-12 col-md-8">
										<select data-placeholder="" class="standardSelect" required name="address_amphur" id="address_amphur">
